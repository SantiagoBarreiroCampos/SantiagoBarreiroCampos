...
- 🤖 Developing *intelligent automation* with *self-healing algorithms*
- 🐍 *Python* is my go-to language for bringing ideas to life
- 📊 Experience in *data science* and *predictive modeling*
- 🎓 Graduate from *Universidad Europea de Madrid*
- 💼 Currently working at *Santander Digital Services*
...
![P2P](https://img.shields.io/badge/P2P-00599C?style=flat-square&logo=webrtc&logoColor=white)
...
|---------|-------------|------|
| [*BitNet*](https://github.com/SantiagoBarreiroCampos/BitNet) | Practical study on the creation and advantages of a BitNet versus a standard neural network | Python |
| [*blockchain-voting*](https://github.com/SantiagoBarreiroCampos/blockchain-voting) | Voting system using blockchain and P2P technologies | Python |
| [*Self-Healing Automation*](https://github.com/SantiagoBarreiroCampos/Automation-project-with-Self-Healing-algorithm) | Automation script with self-healing capabilities using Machine Learning | Python |
| [*BTC Price Prediction*](https://github.com/SantiagoBarreiroCampos/IA_prediccion_precio_BTC) | AI-powered Bitcoin price prediction model | Jupyter |
